...
- [x] **SYNC-04**: UI automatically refreshes when Provider files are added, modified, or deleted via sync
...
- [x] **ONBD-02**: User can also manually create Providers from scratch at any time
