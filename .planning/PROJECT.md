...
>
> **Goal:** 建立完整的构建、签名、分发和自动更新流程，让 app 能实际安装使用并持续迭代
>
> **Target features:**
> - GitHub Actions CI/CD — tag 触发自动构建 macOS DMG
> - CI 版本注入 — 从 git tag 提取版本号注入到构建配置
> - Ad-hoc 代码签名 — CI 构建时 macOS ad-hoc 签名
> - Tauri 自动更新 — 集成 tauri-plugin-updater，通过 GitHub Releases 分发
> - 项目专用发版技能 — CHANGELOG 生成 + tag + push
