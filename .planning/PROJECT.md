...
<!-- Current milestone: v1.1 System Tray -->

- [ ] 系统托盘图标常驻，主窗口关闭后应用驻留在托盘
- [ ] 托盘菜单显示 Provider 列表，支持一键切换
- [ ] 托盘显示当前激活 Provider 的名称/状态
...
| v1 不做托盘 | 聚焦核心功能，托盘快切 v2 再加 | ✓ Good — v1 按时交付，托盘留 v2 |
...
**Current State (v1.0 shipped 2026-03-12):**
- 7,986 LOC (Rust backend + React/TypeScript frontend)
...
- 5 phases, 12 plans, 85 commits in 3 days
...
**Goal:** 添加系统托盘支持，实现常驻后台和快速 Provider 切换

**Target features:**
- 托盘图标常驻，主窗口关闭后应用驻留
- 托盘菜单展示 Provider 列表，一键切换
- 托盘显示当前激活 Provider 名称/状态
